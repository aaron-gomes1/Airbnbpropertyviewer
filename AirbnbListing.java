...
public class AirbnbListing {
    ...
    double reviewsPerMonth, int calculatedHostListingsCount, int availability365) {
        ...
        this.reviewsPerMonth = Math.abs(reviewsPerMonth);
        this.calculatedHostListingsCount = Math.abs(calculatedHostListingsCount);
    ...
    /**
     * Gets all the details in an array
     */
    public String[] getDetails() {
        return new String[]{id, name, host_id, host_name, neighbourhood, "" + latitude, "" + longitude, room_type, "" + price, "" + minimumNights, "" + numberOfReviews, lastReview, "" + reviewsPerMonth, "" + calculatedHostListingsCount, "" + availability365};
    }
